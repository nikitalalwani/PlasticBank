    ...
    private void populateCombo(){
        ...
        for (Type type : Organization.Type.values()){
            if (!type.getValue().equals(Type.Admin.getValue()))
            {
                ...
                {
                    if (!type.getValue().equals(Type.Admin.getValue()) && !type.getValue().equals(Type.IdentifyCollectors.getValue()) && !type.getValue().equals(Type.Warehouse.getValue()))
                        organizationJComboBox.addItem(type);
                } 
                
                if(enterprise instanceof TransportDivisionEnterprise)
                {
                    if (!type.getValue().equals(Type.Admin.getValue()) && !type.getValue().equals(Type.IdentifyCollectors.getValue()) && !type.getValue().equals(Type.Warehouse.getValue()) && !type.getValue().equals(Type.RecyclingFactory.getValue()))
                        organizationJComboBox.addItem(type);
                } 
